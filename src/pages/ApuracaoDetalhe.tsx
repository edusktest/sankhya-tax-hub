    ...
    <div>
      ...
      <Tabs defaultValue="apuracao">
        <TabsList className="bg-muted border">
          <TabsTrigger value="apuracao" className="data-[state=active]:bg-card data-[state=active]:text-primary">
            Apuração
          </TabsTrigger>
          <TabsTrigger value="eventos" className="data-[state=active]:bg-card data-[state=active]:text-primary">
            Eventos
          </TabsTrigger>
          <TabsTrigger value="outras" className="data-[state=active]:bg-card data-[state=active]:text-primary">
            Outras Informações
          </TabsTrigger>
        </TabsList>
              ...
              <TableBody>
                {contasApuracao.map((c, i) => {
                  ...
                  return (
                    <TableRow
                      key={i}
                      className={`${isTotal ? "bg-muted/30 font-semibold" : ""} hover:bg-muted/20`}
                    >
                      <TableCell className={isSubItem ? "pl-10 text-muted-foreground text-sm" : ""}>
                        {c.conta.trim()}
                        {c.status && (
                          <Badge variant="outline" className="ml-2 text-xs border-success text-success bg-success/10">
                            {c.status}
                          </Badge>
                        )}
                      </TableCell>
